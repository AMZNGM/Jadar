...
import { ArrowLeftRight, ArrowPath, BgNoise, MovingBorders } from "@/data/mediaData/svgs.jsx";
...
const EastSabahCarousel = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-screen h-screen max-md:h-120 overflow-hidden bg-black text-bg py-12 px-4">
      <Noise />
