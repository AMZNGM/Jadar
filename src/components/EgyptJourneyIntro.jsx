  ...
  return (
    <section ref={sectionRef} className="relative w-screen min-h-screen overflow-hidden bg-transparent text-text">
      ...
      <div className="relative w-full h-screen">
        <div
          ref={btnRef}
          className="absolute top-8 ltf:left-0 rtl:right-0 max-md:size-full opacity-0 -translate-y-100 z-50">
...
export default EgyptJourneyIntro;
