      ...
      <div className="h-full">
        {sections.map((section, i) => (
          <div
            ...
            className="overflow-hidden relative w-full h-1/3">
            <div className="relative size-full">
              <ParallaxElement direction="scale" className="size-full">
                <img
                  src={section.image}
                  alt={`Section ${section.id}`}
                  className="object-cover w-full h-full js-image"
                />
              </ParallaxElement>

              <div className="flex absolute inset-0 z-10 flex-col justify-center items-center p-4 font-light text-center uppercase js-content">
                <div className="mb-8 max-w-6xl text-5xl font-extralight tracking-wider duration-300 js-title max-md:text-3xl text-text">
                  {section.title}
                </div>

                <div className="max-w-5xl text-lg tracking-wide leading-relaxed duration-300 js-desc max-md:text-sm text-text/80">
                  {section.description}
                </div>
              </div>
            </div>
