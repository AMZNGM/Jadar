          ...
          {projects.map((project, index) => (
            <div
              ...
              <ShuffleText
                text={project.title}
                tag={"h4"}
                className={`text-3xl max-md:text-2xl p-4 group-hover:scale-101 duration-300 ${
          ...
          {projects.map((project, index) => (
            <div
              ...
              className={`relative size-full flex flex-col justify-center items-center text-center font-light backdrop-blur-sm border cursor-pointer scale-98 hover:scale-97 duration-300 gap-4 m-4 py-6 max-md:py-4
                          ${
                            index === activeProject
                              ? "bg-main/20 border-main/50 scale-100"
                              : "bg-text/10 border-text/20 hover:bg-text/20"
                          }`}>
              <div className="relative size-full flex max-md:flex-col-reverse justify-between items-start max-md:items-center gap-4">
                <div />

                <h4
                  className={`text-4xl max-md:text-xl font-medium duration-300 ${
                    index === activeProject ? "text-main" : "text-text"
                  }`}>
                  {project.title}
                </h4>
