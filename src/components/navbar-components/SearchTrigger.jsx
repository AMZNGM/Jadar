...
export default function SearchTrigger({ toggleSearchBar }) {
  ...
  return (
    <div onClick={(e) => toggleSearchBar(e)} className="relative h-full">
      <HoverEffect className="relative h-full overflow-hidden cursor-pointer max-[1100px]:hidden p-2 z-0">
        <span className="group relative h-full flex justify-center items-center gap-1 z-20">
